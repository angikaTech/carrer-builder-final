...
const BscAnestesiaOperation = () => {
    ...
    const methods = useForm({
        ...
        defaultValues: {
            ...
            program: "B.Sc Anestesia And Operation Theatre Technology",
            mobielNumber: "",
            dob: "",
            gender: "",
            cityName: "",
    ...
    const handleNext = async (data) => {
        ...
        if (activeStep === steps.length - 1) {
            ...
            } catch (err) { alert("form not submitted")
        console.log(err) }
...
export default BscAnestesiaOperation;