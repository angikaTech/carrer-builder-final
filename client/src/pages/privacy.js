...
const Privacy = () => {
    return (
        <>
            <Header />
            <section id="event">
                <div className="container col-md-12" style={{ textAlign: "justify" }}>

                    <div className="section-content">
                        <div className="row">

                            <div className="col-md-12 pb-sm-20 row " >
                                <div className='col-sm-12'>
                                    ...
                                    <h2 className="title mb-20 font-28 mt-0 line-height-1 ">Privacy Policy</h2>
                                ...
                                <p>Account means a unique account created for You to access our Service or parts of our Service.
                                    ...
                                    CareerBuilder Solutions, Bangalore.</p>
                                <p>Cookies are small files that are placed on Your computer, mobile device or any other device by
                                    a website, containing the details of Your browsing history on that website among its many uses.</p>
                                <h4>Country refers to: India</h4>
                                ...
                                <p>Website refers to CareerBuilder Solutions, accessible from https://careerbuildersolutions.org/</p>
                                <p>You means the individual accessing or using the Service, or the company, or other legal entity
                                ...
                                <h4>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may
                                    include, but is not limited to:</h4>
                                <ul>
                                    <li>Email address</li>
                                ...
                                <p>Cookies or Browser Cookies. A cookie is a small file placed on Your Device. You can instruct
                                    ...
                                    For more information on how You can delete Flash Cookies, please read &quot;Where can I change
                                    ...
                                    flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_
                                    objects_
                                ...
                                <p>
                                    ...
                                    You close Your web browser. You can learn more about cookies here: Cookies by TermsFeed
                                    Generator.
                                </p>
                                ...
                                <ul>
                                    ...
                                    <li><b>Purpose</b>: These Cookies are essential to provide You with services available through the
                                ...
                                <p><b>Type</b>: Persistent Cookies</p>
                                <p><b>Administered by</b>: Us</p>
                                <p><b>Purpose</b>: These Cookies allow us to remember choices You make when You use the Website,
                                ...
                                <p>To manage Your Account: to manage Your registration as a user of the Service. The Personal
                                ...
                                <p>For business transfers: We may share or transfer Your personal information in connection with,
                                    ...
                                    a portion of Our business to another company.</p>
                                ...
                                <h4>The Company may disclose Your Personal Data in the good faith belief that such action is
                                    necessary to:</h4>
                                ...
                                <p><b>By email</b>: info@careerbuildersolutions.org</p>
                                <p><b>By visiting this page on our website</b>: https://careerbuildersolutions.org/</p>
                                <p><b>By phone number</b>: +91-7204238483, +91-8618355370</p>
                            </div>
