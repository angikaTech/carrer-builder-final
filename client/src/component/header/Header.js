            ...
            <nav className="navbar navbar-expand-lg cnav-bg navbar-light custom-header">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse cnav-bg" id="navbarSupportedContent" >
                        ...
                        {user ? <>
                            <div className="navbar-nav col-sm-3 col-md-2"  >
                                <li ><h5 style={{ color: "#fff", paddingTop: "10px", maginRight: "70px" }} onClick="#" ><a href="/dashboard" style={{ color: "#fff", textDecoration: "none" }}>Dashbord</a></h5></li>
                                <li><h5 style={{ color: "#fff", paddingTop: "10px", maginRight: "70px" }}> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </h5></li>
                                <li><h5 style={{ color: "#fff", paddingTop: "10px", maginRight: "70px" }} onClick={signout}><a href="#" style={{ color: "#fff", textDecoration: "none" }}>
                            ...
                            <li ><h5 style={{ color: "#fff", paddingTop: "10px", maginRight: "70px" }}><a href="/adminlogin" style={{ color: "#fff", textDecoration: "none" }}>Login</a></h5></li>
                            <li><h5 style={{ color: "#fff", paddingTop: "10px", maginRight: "70px" }}> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  </h5></li>
                            <li><h5 style={{ color: "#fff", paddingTop: "10px", maginRight: "70px" }}><a href="https://careerbuildersolutions.org/#apply" style={{ color: "#fff", textDecoration: "none" }}>Register</a></h5></li>
                ...
                <div className="container pt-0 pb-0">
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-4 col-md-3 custom-header" >
                            <a  href="/#apply"><img src={reg} alt="reg" 
                             style={{
                        ...
                        >
                            <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive " >
                                <ul class="menuzord-menu" style={{ display: "flex", padding: "20px", backgroundColor: "#fcfcfc", }}>
                                    <li class="active" ><a href="https://careerbuildersolutions.org/" style={{ backgroundClor: "black", textDecoration: "none" }}><b>HOME</b></a></li>
                                    <li ><a href="https://careerbuildersolutions.org/#about" style={{ color: "black", textDecoration: "none" }}><b>ABOUT </b></a></li>
                                    <li><a href="#contact" style={{ color: "black", paddingRight: "0", textDecoration: "none" }}><b>CONTACT </b> </a></li>
