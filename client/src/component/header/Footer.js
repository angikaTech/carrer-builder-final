                ...
                <div className="row">
                    <center>
                        <div className="col-md-12" >
                            <p className="font-11 text-black-777 m-0">Copyright ©{moment().format('YYYY')} <a href="https://careerbuildersolutions.org/" style={{ color: "#0d6efd", textDecoration: "none" }}> CareerBuilder Solutions </a>. All Rights Reserved</p></div>
